    ...
    <div class="lg:w-1/2 px-5 xl:pl-12 pt-10">
        <header>
            <a href="index.html" class="">
                <div class="flex items-center gap-4">
                    ...
                    <h1 class="text-2xl font-bold">Prolift Academy</h1>
                </div>
            </a>
        </header>
        ...
        <div class="max-w-[450px] m-auto pt-24 pb-16">
            <header class="text-center mb-8">
                <h2 class="text-bgray-900 text-4xl font-semibold font-poppins mb-2">
            ...
            <div class="flex flex-col md:flex-row gap-4">
                <a href="#"
                    class="inline-flex justify-center items-center gap-x-2 border border-bgray-300 rounded-lg px-6 py-4 text-base text-bgray-900 font-medium">
                ...
                <a href="#"
                    class="inline-flex justify-center items-center gap-x-2 border border-bgray-300 rounded-lg px-6 py-4 text-base text-bgray-900 font-medium">
                    <svg class="fill-bgray-900" width="21" height="22" viewBox="0 0 21 22" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="relative mt-6 mb-5">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="bg-white px-2 text-base text-bgray-600">Or continue with</span>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="email" class="h-14 w-full" type="email" name="email" :value="old('email')"
                ...
                <div class="flex justify-between mb-7">
                    <div class="flex items-center space-x-3">
                        <input type="checkbox"
                            class="w-5 h-5 focus:ring-transparent rounded-full border border-bgray-300 focus:accent-ut-300 text-ut-300"
                            name="remember" id="remember" />
                        <label for="remember" class="text-bgray-900 text-base font-semibold">Remember
                            me</label>
                    </div>
                    <div>
            ...
            <nav class="flex items-center justify-center flex-wrap gap-x-11 pt-24">
                <a href="#" class="text-sm text-bgray-700">Terms & Condition</a>
                <a href="#" class="text-sm text-bgray-700">Privacy Policy</a>
                <a href="#" class="text-sm text-bgray-700">Help</a>
                <a href="#" class="text-sm text-bgray-700">English</a>
            </nav>
