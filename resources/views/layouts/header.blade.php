...
<div class="searchbar-wrapper">
    <div
        class="px flex h-[56px] w-[300px] items-center justify-between rounded-lg border border-transparent bg-bgray-50 px-4 focus-within:border-ut-300  lg:w-[400px]">
        <div class="flex w-full items-center space-x-3.5">
            <span>
                <svg class="stroke-bgray-900 " width="20" height="20" viewBox="0 0 20 20" fill="none"
            ...
            <label for="search" class="w-full">
                <input type="text" id="search" placeholder="Search..."
                    class="search-input w-full border-none bg-bgray-50 bg-none px-0 text-sm tracking-wide text-bgray-600 placeholder:text-sm placeholder:font-semibold focus:outline-none focus:ring-0  " />
            </label>
        </div>
    </div>
</div>
...
<div class="quick-access-wrapper relative">
    <div class="flex items-center space-x-[43px]">
        <div class="hidden items-center space-x-5 xl:flex">
            <button onclick="notificationAction()" id="notification-btn" type="button"
                class="relative flex h-[52px] w-[52px] items-center justify-center rounded-[12px] border border-bgray-900">
                <span
                    class="absolute -right-[5px] -top-[2px] h-3.5 w-3.5 rounded-full border-2 border-white bg-bgray-300">
                </span>
                <svg class="fill-bgray-900" width="24" height="25" viewBox="0 0 24 25" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <button onclick="messageAction()" type="button" id="message-btn"
                class="relative flex h-[52px] w-[52px] items-center justify-center rounded-[12px] border border-bgray-900">
                <span
                    class="absolute -right-[5px] -top-[2px] h-3.5 w-3.5 rounded-full border-2 border-white bg-error-300 "></span>
    ...
    <div class="notification-popup-wrapper">
        <div onclick="notificationAction()" id="noti-outside" class="fixed -left-[43px] top-0 hidden h-full w-full">
        </div>
        <div id="notification-box" style="filter: drop-shadow(12px 12px 40px rgba(0, 0, 0, 0.08));"
            class="absolute -left-[347px] top-[81px] hidden w-[400px] rounded-lg bg-white">
            <div class="relative w-full pb-[75px] pt-[66px]">
                ...
                <ul class="scroll-style-1 h-[335px] w-full overflow-y-scroll">
                    <li class="border-b border-bgray-200 py-4 pl-6 pr-[50px] hover:bg-bgray-100">
                        <a href="#">
                            <div class="noti-item">
                                <p class="mb-1 text-sm font-medium text-bgray-600 ">
                                    <strong class="text-bgray-900">James
                                        Eusobio</strong>
                                    send a new payment for
                                    <strong class="text-bgray-900">SEO writing</strong>
                                    totaling
                            ...
                            <div class="noti-item">
                                <p class="mb-1 text-sm font-medium text-bgray-600">
                                    <strong class="text-bgray-900 ">James
                                        Eusobio</strong>
                                    send a new payment for
                                    <strong class="text-bgray-900 ">SEO
                                        writing</strong>
                                    totaling
    ...
    <div class="message-popup-wrapper">
        <div onclick="messageAction()" id="mes-outside" class="fixed -left-[43px] top-0 hidden h-full w-full">
        </div>
        <div id="message-box" style="filter: drop-shadow(12px 12px 40px rgba(0, 0, 0, 0.08));"
            class="absolute -left-[276px] top-[81px] hidden w-[400px] rounded-lg bg-white">
            <div class="relative w-full pb-[75px] pt-[66px]">
                <div class="absolute left-0 top-0 flex h-[66px] w-full items-center justify-between px-8">
                    <h3 class="text-xl font-bold text-bgray-900">
                        Message
                ...
                <div>
                    <div class="flex items-center border-b border-bgray-200 ">
                        <button type="button"
                    ...
                    <ul class="scroll-style-1 h-[335px] w-full overflow-y-scroll">
                        <li class="border-b border-bgray-200 px-7 py-6 hover:bg-bgray-100">
                            <a href="#">
                                <div class="flex space-x-3">
                                    <div class="relative h-[48px] w-[48px] rounded-full">
                                        <img src="{{ asset('') }}images/avatar/inbox-1.png" alt="avatar"
                        ...
                        <li class="border-b border-bgray-200 px-7 py-6 hover:bg-bgray-100">
                            <a href="#">
                                <div class="flex space-x-3">
                                    <div class="relative h-[48px] w-[48px] rounded-full">
                                        <img src="{{ asset('') }}images/avatar/inbox-2.png" alt="avatar"
                                            class="h-full w-full object-cover" />
                                        <div
                        ...
                        <li class="border-b border-bgray-200 px-7 py-6 hover:bg-bgray-100">
                            <a href="#">
                                <div class="flex space-x-3">
                                    <div class="relative h-[48px] w-[48px] rounded-full">
                                        <img src="{{ asset('') }}images/avatar/inbox-3.png" alt="avatar"
                                            class="h-full w-full object-cover" />
                                        <div
                                            class="absolute bottom-0 right-0 h-3 w-3 rounded-full border border-white bg-success-300">
                                        </div>
    ...
    <div class="store-wrapper">
        <div id="store-outside" onclick="storeAction()" class="fixed -left-[43px] top-0 hidden h-full w-full">
        </div>
        <div id="store-box" style="filter: drop-shadow(12px 12px 40px rgba(0, 0, 0, 0.08));"
            class="absolute -left-[134px] top-[81px] hidden w-[330px] overflow-hidden rounded-lg bg-white">
                ...
                <div class="bonus-box-wrapper w-full overflow-hidden pb-[33px]">
                    <div class="bonus-box relative flex w-full justify-center">
                        ...
                        <div class="relative w-full rounded-lg bg-success-300 p-5">
                            ...
                            <p class="mb-3 px-5 text-center text-lg font-semibold leading-[24px] text-success-100">
                ...
                <div class="progess-bar mb-[13px] flex justify-center">
                    <div class="bonus-per relative">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="80px" height="80px">
                            <circle style="stroke-dashoffset: calc(215 - 215 * (25 / 100));" cx="40"
                                cy="40" r="35" stroke-linecap="round" />
                        </svg>
                    </div>
                </div>
                    ...
                    <ul>
                        <li class="w-full">
                            <a href="settings.html">
                                <div
                                    class="flex items-center space-x-[18px] rounded-lg p-[14px] text-bgray-600 hover:bg-bgray-100 hover:text-bgray-900 hover:">
                                    <div class="w-[20px]">
                                        <span>
                                    ...
                                    <div class="flex-1">
                                        <span class="text-sm font-semibold text-bgray-900">My
                                            Profile</span>
                                    </div>
                                </div>
                            </a>
