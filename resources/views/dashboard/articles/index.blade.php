                        ...
                        <tr>
                            <th scope="col" class="px-6 py-5 xl:px-0">
                                <div class="flex w-full items-center space-x-2.5">
                                    <p class="text-base font-medium text-bgray-600">Judul</p>
                                </div>
                            </th>
                            <th scope="col" class="px-6 py-5 xl:px-0">
                                <div class="flex w-full items-center space-x-2.5">
                                    <p class="text-base font-medium text-bgray-600">Gambar</p>
                                </div>
                            </th>
                            <th scope="col" class="px-6 py-5 xl:px-0">
                                <div class="flex items-center space-x-2.5">
                                    <p class="text-base font-medium text-bgray-600">Status</p>
                                </div>
                            </th>
